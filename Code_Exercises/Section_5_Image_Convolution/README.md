...
```sh
cd build/Code_Exercises/Section_5_Image_Convolution
```
and execute:
* ```make Section_5_Image_Convolution_reference``` - to build reference.cpp
* ```make``` - to build reference.cpp

Alternatively from a terminal at the command line:
```sh
icpx -fsycl -o Section_5_Image_Convolution_reference -I../../Utilities/include/ -I../../External/stb ../Code_Exercises/Section_5_Image_Convolution/reference.cpp
```
...
```sh
#!/bin/bash
./Section_5_Image_Convolution_reference
```
and run:
```sh
...
make Section_5_Image_Convolution_reference
```
Alternatively from a terminal at the command line:
```sh
icpx -fsycl -o Section_5_Image_Convolution_reference -I../../Utilities/include/ -I../../External/stb reference.cpp
```
...
```sh
cd Code_Exercises/Section_5_Image_Convolution
/path/to/adaptivecpp/bin/acpp -o sycl-Section_5_Image_Convolution_reference -I../../Utilities/include/ -I../../External/stb --acpp-targets="<target specification>" reference.cpp
```
