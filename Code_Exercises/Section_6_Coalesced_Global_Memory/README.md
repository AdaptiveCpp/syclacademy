...
```sh
cd build/Code_Exercises/Section_6_Coalesced_Global_Memory
```
and execute:
* ```make Section_6_Coalesced_Global_Memory_source``` - to build source.cpp
* ```make Section_6_Coalesced_Global_Memory_solution``` - to build the solution provided
* ```make``` - to build both

Alternatively from a terminal at the command line:
```sh
icpx -fsycl -o Section_6_Coalesced_Global_Memory_source -I../../Utilities/include/ -I../../External/stb ../Code_Exercises/Section_6_Coalesced_Global_Memory/source.cpp
```
...
```sh
#!/bin/bash
./Section_6_Coalesced_Global_Memory_source
```
and run:
```sh
...
make Section_6_Coalesced_Global_Memory_source
```
Alternatively from a terminal at the command line:
```sh
icpx -fsycl -o Section_6_Coalesced_Global_Memory_source ../Code_Exercises/Section_6_Coalesced_Global_Memory/source.cpp
./Section_6_Coalesced_Global_Memory_source
```
...
```sh
cd Code_Exercises/Section_6_Coalesced_Global_Memory
/path/to/adaptivecpp/bin/acpp -o Section_6_Coalesced_Global_Memory_source --acpp-targets="<target specification>" source.cpp
./Section_6_Coalesced_Global_Memory_source
```
